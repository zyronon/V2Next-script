...
(function (vue) {
  ...
  const _withScopeId$d = (n2) => (vue.pushScopeId("data-v-402be427"), n2 = n2(), vue.popScopeId(), n2);
  ...
  const _hoisted_56 = /* @__PURE__ */ _withScopeId$d(() => /* @__PURE__ */ vue.createElementVNode("label", { class: "item-title" }, "调试模式", -1));
  const _hoisted_57 = { class: "wrapper" };
  const _hoisted_58 = /* @__PURE__ */ _withScopeId$d(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "desc" }, " 开启此项会显示调试控制台，刷新页面生效 ", -1));
  ...
  const Setting = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["render", _sfc_render$9], ["__scopeId", "data-v-402be427"]]);
  const _sfc_main$k = {
    name: "Point",
    components: { Icon },
    inject: ["post", "isLogin"],
