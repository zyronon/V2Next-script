...
(function (vue, dayjs) {
  ...
  const _withScopeId$a = (n2) => (vue.pushScopeId("data-v-b9e2f035"), n2 = n2(), vue.popScopeId(), n2);
  const _hoisted_1$f = {
    key: 0,
    class: "setting-modal modal"
  };
  ...
  const Setting = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["render", _sfc_render$8], ["__scopeId", "data-v-b9e2f035"]]);
  const _sfc_main$e = {
    name: "Point",
