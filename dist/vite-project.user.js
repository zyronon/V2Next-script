...
(function (vue) {
  ...
  const _withScopeId = (n2) => (vue.pushScopeId("data-v-8fc2c121"), n2 = n2(), vue.popScopeId(), n2);
  const _hoisted_1 = {
    key: 0,
    ...
    return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
      ...
      !$data.stopMe && $data.config.showToolbar ? (vue.openBlock(), vue.createElementBlock("div", {
        ...
        $options.isPost && !$data.show ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_7, [
          ...
          vue.createTextVNode(" " + vue.toDisplayString($data.stopMe) + " ", 1),
          vue.createElementVNode("div", {
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-8fc2c121"]]);
